...
- Use generated or caller-supplied transaction/correlation IDs to join request events. Authenticated requests record
  `user_id` as a `sha256:`-prefixed, 12-hex-character pseudonym; never log the raw JWT subject.
